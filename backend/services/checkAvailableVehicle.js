...
export async function availableAtDate(pickupDate, dropOffDate) {
  try {
    // Note: The previous logic only checked dates for vehicles without bookings,
    // but did not check the status of the trip. The updated logic below handles it properly.
