    ...
    <>
      {isOrderModalOpen ? (
        <div
          ...
          onClick={closeModal}
        >
          <div className=" relative m-4 mx-auto  min-w-[300px] md:min-w-[500px] max-w-[40%]  rounded-lg bg-white font-sans text-base font-light leading-relaxed text-slate-800 antialiased shadow-2xl">
            ...
            <div className="flex flex-wrap items-center justify-end p-4 shrink-0 text-slate-800">
              <button
